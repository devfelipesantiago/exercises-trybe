...
# edido por uma determinada pessoa cliente, considerando que os pedidos estão
# em uma lista.
...
# uma fixture utilizando a biblioteca pytest é definida utilizando a
# sintaxe abaixo
...
# def
# test_get_order_frequency_per_costumer_when_customer_is_joao_and_order_is_pizza(
#     orders,
# ):
# assert get_order_frequency_per_costumer(orders, "joao", "pizza") == 0
# def
# test_get_order_frequency_per_costumer_when_customer_is_maria_and_order_is_hamburger(
#     orders,
# ):
