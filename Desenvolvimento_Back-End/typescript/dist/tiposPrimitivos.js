 ...
 */
let yes = true; // cria uma variável de nome "yes" e diz que o tipo é booleano e o valor é true
let no = false; // cria uma variável de nome "no" e diz que o tipo é booleano e o valor é false
